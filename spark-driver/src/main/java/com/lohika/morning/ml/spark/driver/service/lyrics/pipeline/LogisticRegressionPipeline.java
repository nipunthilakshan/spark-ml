...
public class LogisticRegressionPipeline extends CommonLyricsPipeline {
    ...
    protected String getModelDirectory() {
        ...
        System.out.println("Current Working Directory is = " + directoryName +"---"+ getLyricsModelDirectoryPath() + "/logistic-regression/");

        return directoryName + getLyricsModelDirectoryPath() + "/logistic-regression/";
    }
